...
if &t_Co >= 256 || has('gui_running')
  ...
  hi  Error                                   term=bold  cterm=bold  ctermfg=124  guifg=#dc322f guibg=#ffffff gui=bold
  hi  ErrorMsg                                term=reverse  cterm=reverse  ctermfg=124  guifg=#dc322f guibg=#ffffff  gui=reverse
