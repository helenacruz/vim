...
if &t_Co >= 256 || has('gui_running')
  ...
  hi Error                                                      term=bold  cterm=bold  ctermfg=124  gui=bold  guifg=#dc322f guibg=#ffffff 
  hi ErrorMsg                                                   term=reverse  cterm=reverse  ctermfg=124  gui=reverse  guifg=#dc322f guibg=#ffffff 
  ...
  hi Error                  										term=bold  cterm=bold  ctermfg=1 ctermbg=255 
  hi ErrorMsg                                                       term=reverse  cterm=reverse  ctermfg=1 ctermbg=255
